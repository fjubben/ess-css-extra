...
echo "===="
pwd >> 5_org.csstudio.display.builder.log

(cd org.csstudio.display.builder; time mvn $MVNOPT --settings ../ess-css-extra/maven/settings-no-tests.xml -Dcss_repo=file:/home/jenkins/workspace/css-manual/ess-css-extra/ess_css_comp_repo clean verify) | tee 5_org.csstudio.display.builder.log
